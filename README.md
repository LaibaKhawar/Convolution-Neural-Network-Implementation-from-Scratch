# Convolution Neural Network Implementation From Scratch

An educational implementation and experiment exploring **convolution neural network implementation from scratch**. This repository preserves the original work while adding the structure and documentation needed to understand, reproduce, and extend it.
...
```bash
git clone https://github.com/LaibaKhawar/Convolution-Neural-Network-Implementation-from-Scratch.git
cd Convolution-Neural-Network-Implementation-from-Scratch
```
